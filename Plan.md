...
### Сценарий №3. Оплата по удаленной карте валидными данными.
*Входные данные:*
...
### Сценарий №4. Оплата в кредит по удаленной карте валидными данными.
*Входные данные:*
- Номер карты - (DECLINED) — 5555 6666 7777 8888;
- Месяц - в виде ММ от 01 до 12 - главное чтоб месяц не был прошлым от текущей даты;
- Год - любой (от текущей даты + 5 лет);
...
### Сценарий №19. Ввод в поле "Владелец" любых символов, кроме латиницы.
*Входные данные:*
- Номер карты - (APPROVED) — 1111 2222 3333 4444;
- Месяц - в виде ММ от 01 до 12 - главное чтоб месяц не был прошлым, от текущей даты;
- Год - любой (от текущей даты + 5 лет);
- Владелец - имя и фамилия любых символов, кроме латиницы;
- CVC/CVV - трехзначное число.
